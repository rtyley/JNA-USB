 ...
 */
public class pthread_barrier_t extends com.sun.jna.Union {
	/// C type : char[20]
	...
	public pthread_barrier_t(int __align) {
		super();
	...
	protected pthread_barrier_t newInstance() {
		pthread_barrier_t s = new pthread_barrier_t();
		s.useMemory(getPointer());
		write();
		s.read();
		return s;
